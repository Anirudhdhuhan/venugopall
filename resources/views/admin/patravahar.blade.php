        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body  yn-tile">
                    <h3 class="yn-tile-heading">Patra Vyavahar List</h3>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content modal-content-block">
            <div class="modal-header no-btm-bdr">
                <h4 class="modal-hedaing add-work">Add Patra Vyavahar</h4>
                <button type="button" class="close btn-large add-cross" data-dismiss="modal">&times;</button>
            </div>
                <div class="row">
                    <div class="modal-body each-modal-pding">
                        <form id="add_work_form" name="add_presscoverage_form" action="{{ URL::to('/') . '/admin/add-patravahar' }}" method="POST" enctype="multipart/form-data">
                            <div class="col-md-3 title">Title :</div>
                            <div class="col-md-9">
                                <input type="text" required class="create-work-form f-deco wid" id="patra_title" name="patra_title">
                            </div>
                            

                            <div class="col-md-3 title">Images :</div>
                            <div class="col-md-9">
                                <input required type="file" id="patra_image" name="patra_image[]" size="5" multiple>
                            </div>
                            <div class="col-md-12">
    ...
    <div class="modal-dialog" style="width:300px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Delete Patra Vyavahar</h4>
            </div>
            <div class=" modal-body row" style="text-align:center;">
                Are you sure delete this Patra Vyavahar?
...
<div id="edit_press_modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Edit Patra Vyavahar</h4>
            </div>
...
<div id="view_press_modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" style="width:1000px">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">View Patra Vyavahar</h4>
            </div>
...
<script type="text/javascript">
    admincontroller.patravaharlist_grid();
    var base_url = "{{ URL::to('/') }}";
    $('#add').click(function() {
    ...
    $('#delete_press_details').on('click', function() {
        ...
        $.ajax({
            method: "post",
            url: base_url + '/admin/deletepatravahar',
            data: {
                'id': datarow.id
            },
    ...
    $('#edit_press').on('click', function() {
        ...
        $.ajax({
            method: 'get',
            url: base_url + '/admin/editviewpatravahar',
            data: {
                'patra_id': datarow.id
            },
            success: function(data) {
    ...
    $('#view_press').on('click', function() {
        ...
        $.ajax({
            method: 'post',
            url: base_url + '/admin/viewpatravahar',
            data: {
                'patra_id': datarow.id
            },
            success: function(data) {
