        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body  yn-tile">
                    <h3 class="yn-tile-heading">Cultural Event List</h3>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content modal-content-block">
            <div class="modal-header no-btm-bdr">
                <h4 class="modal-hedaing add-work">Add Cultural Event</h4>
                <button type="button" class="close btn-large add-cross" data-dismiss="modal">&times;</button>
            </div>
                <div class="row">
                    <div class="modal-body each-modal-pding">
                        <form id="add_work_form" name="add_work_form" action="{{ URL::to('/') . '/admin/add-culturalevent' }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-dialog" style="width:300px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Delete Cultural Event</h4>
            </div>
            <div class=" modal-body row" style="text-align:center;">
                Are you sure delete this Cultural Event?
...
<div id="edit_work_modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Edit Cultural Event</h4>
            </div>
...
<div id="view_press_modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" style="width:1000px">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">View Cultural Event</h4>
            </div>
...
<script type="text/javascript">
    admincontroller.culturaleventlist_grid();
    var base_url = "{{ URL::to('/') }}";
    $('#add').click(function() {
    ...
    $('#delete_work').on('click', function() {
        ...
        if (!datarow) {
            alert('Please select a Cultural Event');
            return;
        }
    ...
    $('#delete_work_details').on('click', function() {
        ...
        $.ajax({
            method: "post",
            url: base_url + '/admin/deleteculturalevent',
            data: {
                'id': datarow.id
            },
    ...
    $('#edit_work').on('click', function() {
        ...
        $.ajax({
            method: 'get',
            url: base_url + '/admin/editviewculturalevent',
            data: {
                'event_id': datarow.id
            },
            success: function(data) {
    ...
    $('#add_image').on('click', function() {
        ...
        $.ajax({
            method: 'get',
            url: base_url + '/admin/editculturaleventimage',
            data: {
                'event_id': datarow.id
            },
            success: function(data) {
    ...
    $('#edit_work_save').on('click', function() {
        ...
        $.ajax({
            method: 'post',
            url: base_url + '/admin/editculturaleventsave',
            data: $('#edit_work_form').serialize() + "&event_id=" + event_id,
            success: function(data) {
    ...
    $('#view_press').on('click', function() {
        ...
        $.ajax({
            method: 'post',
            url: base_url + '/admin/viewculturalevent',
            data: {
                'event_id': datarow.id
            },
            success: function(data) {
